...
budget_data_txt_path = os.path.join("Analysis" , "budget_analysis.txt")
...
#budget_file = os.path.join("Output", "budget_analysis.txt")
with open(budget_data_txt_path, "w") as outfile:
